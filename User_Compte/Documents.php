...
<body class="font-sans bg-gray-100">
    ...
    <!-- Sidebar -->
    <div class="bg-gray-900 text-white h-screen w-64 fixed top-0 left-0 pt-24 overflow-x-hidden">
        <a href="Home.php" class="block py-3 px-4 hover:bg-gray-700">Home</a>
        <a href="Books.php" class="block py-3 px-4 hover:bg-gray-700 flex items-center">
